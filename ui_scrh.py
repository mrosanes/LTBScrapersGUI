...
#
# Created: Thu Jul 21 16:22:24 2011
...
class Ui_SCRH(object):
    def setupUi(self, SCRH):
        ...
        self.leftStepper = widget.TauGroupBox(self.leftJaw)
        ...
        self.leftLabelState = widget.TauValueLabel(self.leftStepper)
        ...
        self.leftLedState = widget.TauStateLed(self.leftStepper)
        ...
        self.leftLimitN = widget.TauLimitSwitch(self.leftStepper)
        ...
        self.leftLimitP = widget.TauLimitSwitch(self.leftStepper)
        ...
        self.leftInStepperUnits = widget.TauConfigLabel(self.leftStepper)
        ...
        self.leftOutStepperUnits = widget.TauConfigLabel(self.leftStepper)
        ...
        self.leftAbsStepperUnits = widget.TauConfigLabel(self.leftStepper)
        ...
        self.leftEnc = widget.TauGroupBox(self.leftJaw)
        ...
        self.leftEncRead = widget.TauValueLabel(self.leftEnc)
        ...
        self.leftEncUnits = widget.TauConfigLabel(self.leftEnc)
        ...
        self.rightStepper = widget.TauGroupBox(self.rightJaw)
        ...
        self.rightLabelState = widget.TauValueLabel(self.rightStepper)
        ...
        self.rightLedState = widget.TauStateLed(self.rightStepper)
        ...
        self.rightLimitN = widget.TauLimitSwitch(self.rightStepper)
        ...
        self.rightLimitP = widget.TauLimitSwitch(self.rightStepper)
        ...
        self.rightInStepperUnits = widget.TauConfigLabel(self.rightStepper)
        ...
        self.rightOutStepperUnits = widget.TauConfigLabel(self.rightStepper)
        ...
        self.rightAbsStepperUnits = widget.TauConfigLabel(self.rightStepper)
        ...
        self.rightEnc = widget.TauGroupBox(self.rightJaw)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rightEncRead = widget.TauValueLabel(self.rightEnc)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rightEncUnits = widget.TauConfigLabel(self.rightEnc)
